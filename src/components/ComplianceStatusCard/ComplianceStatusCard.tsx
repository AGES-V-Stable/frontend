  ...
  switch (status) {
    case ComplianceStatus.IN_REVIEW:
      return (
        <div className="flex flex-col gap-y-5 items-center justify-center py-[61px] px-[70px] bg-[#FFFFFF] rounded-[16px] border border-[#BBCABF]">
          <img
            className="p-[22px] bg-[#EFF6FF] rounded-full"
            src={clockIcon}
            alt="svg em análise"
          />
          <p className="text-[14px] font-medium py-[7px] px-[14px] text-[#0284C7] bg-[#EFF6FF] rounded-[16px]">
            Em análise
          </p>
          <h1 className="text-[32px] text-[#0F172A] font-bold">Seu cadastro está em análise</h1>
          <p className="text-[16px] text-[#64748B] font-regular max-w-[620px] text-center">
          ...
          <div className="bg-[#EFF6FF] border border-[#0284C7] rounded-[16px] w-[600px] h-[96px] p-4">
            <h2 className="text-[16px] text-[#0F172A] font-bold">
              Análise de compliance em andamento
            </h2>
            <p className="text-[14px] text-[#64748B] font-regular">
    ...
    case ComplianceStatus.APPROVED:
      return (
        <div className="flex flex-col gap-y-5 items-center justify-center py-[61px] px-[70px] bg-[#FFFFFF] rounded-[16px] border border-[#BBCABF]">
          <img
            className="p-[22px] bg-[#ECFDF5] rounded-full"
            src={checkIcon}
            alt="svg em análise"
          />
          <p className="text-[14px] font-medium py-[7px] px-[14px] text-[#059669] bg-[#ECFDF5] rounded-[16px]">
            Aprovado
          </p>
    ...
    case ComplianceStatus.NOT_APPROVED:
      return (
        <div className="flex flex-col gap-y-5 items-center justify-center py-[61px] px-[70px] bg-[#FFFFFF] rounded-[16px] border border-[#BBCABF]">
          <img
            className="p-[22px] bg-[#FEF2F2] rounded-full"
            src={closeIcon}
            alt="svg em análise"
          />
          <p className="text-[14px] font-medium py-[7px] px-[14px] text-[#DC2626] bg-[#FEF2F2] rounded-[16px]">
            Não aprovado
          </p>
